...
public class PossibleBipartion {
    ...
    @Test
    void example4() {
        Assertions.assertFalse(solution.possibleBipartition(5, new int[][]{{1, 2}, {3, 4}, {4, 5}, {3, 5}}));
    }
    ...
    void example5() {
        ...
        Assertions.assertTrue(solution.possibleBipartition(50, dislikes));
    }

    @Test
    void example6() {
        Assertions.assertTrue(solution.possibleBipartition(1, new int[][]{}));
    }
}
